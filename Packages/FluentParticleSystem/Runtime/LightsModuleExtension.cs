...
namespace OUCC.FluentParticleSystem
{
    public static class LightsModuleExtension
    {
        ...
        #region MaxLights
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParticleSystem SetLightsMaxLights(this ParticleSystem particleSystem, Int32 maxLights)
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(particleSystem, nameof(particleSystem));
            var module = particleSystem.lights;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParticleSystem SetLightsMaxLights(this ParticleSystem particleSystem, Func<Int32, Int32> maxLightsChanger)
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(particleSystem, nameof(particleSystem));
            var module = particleSystem.lights;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LightsModule SetMaxLights(this LightsModule module, Int32 maxLights)
        {
            module.maxLights = maxLights;
            return module;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LightsModule SetMaxLights(this LightsModule module, Func<Int32, Int32> maxLightsChanger)
        {
            module.maxLights = maxLightsChanger(module.maxLights);
            return module;
        }
