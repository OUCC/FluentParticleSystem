...
namespace OUCC.FluentParticleSystem
{
    public static class NoiseModuleExtension
    {
        ...
        #region OctaveCount
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParticleSystem SetNoiseOctaveCount(this ParticleSystem particleSystem, Int32 octaveCount)
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(particleSystem, nameof(particleSystem));
            var module = particleSystem.noise;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ParticleSystem SetNoiseOctaveCount(this ParticleSystem particleSystem, Func<Int32, Int32> octaveCountChanger)
        {
            ThrowHelper.ThrowArgumentNullExceptionIfNull(particleSystem, nameof(particleSystem));
            var module = particleSystem.noise;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoiseModule SetOctaveCount(this NoiseModule module, Int32 octaveCount)
        {
            module.octaveCount = octaveCount;
            return module;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NoiseModule SetOctaveCount(this NoiseModule module, Func<Int32, Int32> octaveCountChanger)
        {
            module.octaveCount = octaveCountChanger(module.octaveCount);
            return module;
        }
